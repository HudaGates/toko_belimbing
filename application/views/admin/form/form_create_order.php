...
<div class="modal-header bg-<?=$this->qt->thema;?>">
    <h4 class="modal-title">FORM CREATE ORDER</h4>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control col-10" id="fileupload" type="file" name="fileimport"
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                        <div class="callout callout-danger" style="padding: 3px">
                            <big><code>Ketentuan Create Order Supplier</code></big>
                            <ul>
                                <li><b>1. Cek Stok</b> (jika tidak sesuai aktual silakan di jugement. )</li>
                                <li><b>2. Qty Order</b> (Pastikan Lebih dari 0)</li>
                                <li><b>3. Periode</b> (Sesuaikan dengan aktual)</li>
                                <li><b>4. </b>Setelah Submit pastikan order baru muncul di data.</li>
                            </ul>
                        </div>
                    </div>
                </div>
