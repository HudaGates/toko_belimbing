  ...
  <!-- /.box-header -->
  <!-- form start -->
      <?=form_open('mastercrud/delete_all?api='.$id_t, 'id="mydata"'); ?>
        <input id="table" type="hidden" name="table" value="tbl_history_partlabel">
        <div class="box-body">                               
            <div class="form-group">
              <label for="exampleInputEmail1">Lot No</label>
              <input id="lot_no" type="text" class="form-control" name="lot_no" class="form-control">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Lot Seq</label>
              <input id="lot_seq" type="text" class="form-control" name="lot_seq" class="form-control">
            </div>                        
          </div>
    <!-- /.box-body -->
