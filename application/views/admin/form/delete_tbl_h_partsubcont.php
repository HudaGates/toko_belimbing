  ...
  <div class="small-box text-purple" style="border:1px solid #ccd;margin:5px;padding: 2px;">
      <div class="box-header with-border">
        ...
        <small class="text-danger">*Data All per SJ akan terhapus</small>
      </div>
  <!-- /.box-header -->
  <!-- form start -->
      <?=form_open('mastercrud/delete_all?api='.$id_t, 'id="mydata3"'); ?>
        ...
        <div class="box-body">                               
            <div class="form-group">
              <label for="exampleInputEmail1">SJ NO</label>
              <input id="sj_no" type="text" class="form-control" name="sj_no" class="form-control">
            </div>                        
          </div>
    <!-- /.box-body -->
