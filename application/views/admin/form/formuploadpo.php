...
<div class="modal-header bg-<?=$this->qt->thema;?>">
  <h4 class="modal-title">UPLOAD PO ROW MATERIAL</h4>
      ...
      <form id="submit">
        <div class="form-group">
          <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
              <label for="exampleInputFile">File upload excel<a href="<?=base_url()?>formatexcel/<?='PO_202007';?>.xlsx" class="btn btn-default text-green" title="Download Format Excel Upload">
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
          <div class="callout callout-danger" style="padding: 3px">
            <big><code>Ketentuan Upload PO</code></big>
            <ul>
              ...
              <li><b>4. QTY PO</b> (Pastikan Lebih dari 0)</li>
...
$(document).ready(function(){
  ...
  $('#submit').submit(function(e){
      ...
      e.preventDefault(); 
           $.ajax({
               url:'<?=base_url('planning/uploadpo?api='.$id_t);?>',
               type:"post",
...
function gagalupload(table){
    $.ajax({
          type: "POST",
          url : "<?=base_url('planning/gagaluploadpo?api='.$id_t); ?>",
