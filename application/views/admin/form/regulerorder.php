...
<div class="modal-header bg-<?=$this->qt->thema;?>">
    <h4 class="modal-title">UPLOAD ORDER CUSTOMER<sup><i class="fa fa-plus text-success"></i></sup></h4>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        ...
                        <div class="form-group">
                            <label for="exampleInputFile">File upload excel <a
                                    href="<?=base_url()?>formatexcel/<?='order_customer';?>.xlsx"
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                        <div class="callout callout-danger" style="padding: 3px">
                            <big><code>Ketentuan Reguler Order</code></big>
                            <ul>
                                <li><b>1. Customer & Part No</b> (Pastikan ada di Master Partlist)</li>
                                <li><b>2. Po No & Part No</b> (Pastikan Belum ada di Order Customer)</li>
                                <li><b>3. PO Qty</b> (Pastikan Lebih dari 0)</li>
                                <li><b>4. </b>Pastikan kolom-kolom lain terisi dengan baik</li>
                                <li><b>5. Case No</b> (Khusus TAM)</li>
                                <li><b>6. Auto Daily Calculation</b>(Pastikan ada history calculation status 'Release')</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    $('#submit').submit(function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: '<?=base_url('planning/uploadreguler?api='.$id_t);?>',
            type: "post",
